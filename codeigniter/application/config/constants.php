...
defined('ESTADO_NOTIFICACION_PENDIENTE') OR define('ESTADO_NOTIFICACION_PENDIENTE', 1);
defined('ESTADO_NOTIFICACION_ENVIADA') OR define('ESTADO_NOTIFICACION_ENVIADA', 2);
defined('ESTADO_NOTIFICACION_LEIDA') OR define('ESTADO_NOTIFICACION_LEIDA', 3);
