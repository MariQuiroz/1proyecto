...
defined('ESTADO_PUBLICACION_ELIMINADO') OR define('ESTADO_PUBLICACION_ELIMINADO', 0);
...
defined('ESTADO_PUBLICACION_RESERVADA') OR define('ESTADO_PUBLICACION_RESERVADA', 4);
...
defined('ESTADO_SOLICITUD_RESERVA_TEMPORAL') OR define('ESTADO_SOLICITUD_RESERVA_TEMPORAL', 5);
defined('ESTADO_SOLICITUD_EXPIRADA') OR define('ESTADO_SOLICITUD_EXPIRADA', 6);
defined('ESTADO_SOLICITUD_CANCELADA') OR define('ESTADO_SOLICITUD_CANCELADA', 7);
...
defined('TIEMPO_RESERVA') OR define('TIEMPO_RESERVA', 7200); // 2 HORAS(2*3600SEGUNDOS)

// Constantes para tiempos límite
defined('TIEMPO_LIMITE_SOLICITUD') OR define('TIEMPO_LIMITE_SOLICITUD', 120); // 2 HORAS EN MINUTOS
...
defined('NOTIFICACION_ELIMINACION') OR define('NOTIFICACION_ELIMINACION', 8);
defined('NOTIFICACION_SOLICITUD_EXPIRADA') OR define('NOTIFICACION_SOLICITUD_EXPIRADA', 9);
defined('NOTIFICACION_CANCELACION_SOLICITUD') OR define('NOTIFICACION_CANCELACION_SOLICITUD', 10);
defined('NOTIFICACION_EXPIRACION_ENCARGADO') OR define('NOTIFICACION_EXPIRACION_ENCARGADO', 11);
