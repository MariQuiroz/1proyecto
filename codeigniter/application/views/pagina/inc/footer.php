...
<footer class="footer-custom">         
    <div class="container">             
        <div class="row">                 
            <div class="col-md-4">                     
                <h5 class="font-weight-bold mb-4 text-white">Contacto</h5>                     
            ...
            <div class="col-md-4">                     
                <h5 class="font-weight-bold mb-4 text-white">Horario de Atención</h5>                     
                <p><i class="la la-clock mr-2"></i> Lunes a Viernes: 8:00 - 18:00</p>                     
                <p><i class="la la-clock mr-2"></i> Sábado: 8:00 - 12:00</p>                 
            </div>                 
            <div class="col-md-4">                 
                <h5 class="font-weight-bold mb-4 text-white">Dirección</h5>                 
                <p><i class="la la-map-marker mr-2"></i> Campus Central UMSS - Biblioteca Central </p>                 
                <p><i class="la la-clock mr-2"></i> Av. Ballivián esq. Oquendo</p>                 
                <p><i class="la la-clock mr-2"></i>Cochabamba, Bolivia</p>                                          
            </div>                              
        </div>             
        <hr class="border-light mt-4">             
        <div class="row mt-3">                 
            <div class="col text-center">                     
                <p class="mb-0">&copy; <?php echo date('Y'); ?> Hemeroteca José Antonio Arze - UMSS</p>                 
            </div>             
        </div>         
    </div>     
</footer>          
