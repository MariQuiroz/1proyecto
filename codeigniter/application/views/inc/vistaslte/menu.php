                                ...
                                <div class="card cta-box bg-info text-white">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            <img class="ml-3" src="<?php echo base_url(); ?>/adminXeria/dist/assets/images/update.svg" width="120" alt="Generic placeholder image">
                                        </div>
                                    </div>
                                    <!-- end card-body -->
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="<?php echo base_url(); ?>/adminXeria/dist/assets/images/users/user-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="<?php echo base_url(); ?>/adminXeria/dist/assets/images/users/user-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="<?php echo base_url(); ?>/adminXeria/dist/assets/images/users/user-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="<?php echo base_url(); ?>/adminXeria/dist/assets/images/users/user-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="<?php echo base_url(); ?>/adminXeria/dist/assets/images/users/user-6.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                                    </td>
