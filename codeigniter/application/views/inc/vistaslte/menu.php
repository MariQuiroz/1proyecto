        ...
        <header id="navbar">
            <div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="<?php echo base_url(); ?>adminNifty\pages\index.html" class="navbar-brand">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>adminNifty\pages\pages-login.html"><i class="demo-pli-unlock icon-lg icon-fw"></i> Logout</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
					            ...
					            <div class="panel panel-trans">
					                <div class="pad-all">
					                    <div class="media mar-btm">
					                        <div class="media-left">
					                            <img src="<?php echo base_url(); ?>adminNifty\pages\assets\img\profile-photos\2.png" class="img-md img-circle" alt="Avatar">
					                        </div>
					                        <div class="media-body">
