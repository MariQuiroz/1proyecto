...
<html lang="en">
    <head>
        ...
        <!-- third party css -->
        <link href="adminXeria/dist/assets/libs/datatables/dataTables.bootstrap4.css" rel="stylesheet" type="text/css" />
        <link href="adminXeria/dist/assets/libs/datatables/responsive.bootstrap4.css" rel="stylesheet" type="text/css" />
        <link href="adminXeria/dist/assets/libs/datatables/buttons.bootstrap4.css" rel="stylesheet" type="text/css" />
        <link href="adminXeria/dist/assets/libs/datatables/select.bootstrap4.css" rel="stylesheet" type="text/css" />
        <!-- third party css end -->

        <!-- App css -->
        <link href="adminXeria/dist/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="adminXeria/dist/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <link href="adminXeria/dist/assets/css/app.min.css" rel="stylesheet" type="text/css" />
                ...
                <div class="logo-box">
                    <a href="index.html" class="logo text-center">
                        ...
                        <span class="logo-sm">
                            ...
                            <img src="adminXeria/dist/assets/images/logo-sm.png" alt="" height="18">
                        </span>
                    </a>
                </div>
